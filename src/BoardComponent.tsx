...
import { c4Columns, c4Rows } from "src/index/index";
import GameRow from "src/RowComponent";
...
const GameBoard: React.FunctionComponent = (): JSX.Element => {
  ...
  return (
    ...
    <p style={{ textAlign: "center" }}>
      A classic strategy game for two players on the same computer. <br/> <br/> Drop your colored discs into the grid by clicking the mouse on the desired column and try to connect four of them vertically, horizontally, or diagonally before your opponent does.
      <br/>
      <br/>
      Once you've clicked a column, it's now the other player's turn. Play repeats until one player has won!
    </p>
      <table>
        <thead></thead>
        <tbody>
